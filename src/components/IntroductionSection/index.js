  ...
  return (
    <section className="py-20 dark:bg-gray-800">
      <div className="container mx-auto px-4">
        <div className=" mx-auto flex flex-col md:flex-row items-center mb-12">
          <div className="md:w-1/2 mb-6 md:mb-0">
            <h2 className="text-3xl font-bold text-greencustom mb-4">À propos de Jerico 4.0</h2>
            ...
            <div className="w-100 h-1 bg-greencustom m-auto mt-10 rounded-full "></div>
          </div>
          
          <div className="md:w-1/2 flex justify-center">
            <img src="./img/3.png" alt="Gestion de contenu web" className="max-w-full h-auto" />
          </div>
        </div>
      </div>
    </section>
